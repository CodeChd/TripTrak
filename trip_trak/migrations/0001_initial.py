    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('event', 'Event'), ('dinning', 'Dinning'), ('experience', 'Experience'), ('general', 'General')], max_length=100)),
                ...
                ('trip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='notes', to='trip_trak.trip')),
            ],
        ),
    ]
