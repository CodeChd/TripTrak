...
from .views import HomeView, NoteCreateView, NoteDeleteView, NoteDetailView, NoteListView, NoteUpdateView, TripCreateView, TripDeleteView, TripDetailView, TripUpdateView, trip_list
...
# update - uses the same form as the createview which is teh model_form.html
